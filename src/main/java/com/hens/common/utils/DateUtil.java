...
public class DateUtil extends DateUtils {
     ...
     * 日期格式年 月 日 时 分 秒 如 2009-02-26 15:40:00
     */
    private static final DateTimeFormatter DTF =DateTimeFormatter.ofPattern(DATEFORMATSECOND);
	/**
...
//        }
     ...
     * @return
     */
    public static String getTimeAfterMin(String time, long min) {
        return LocalDateTime.from(DTF.parse(time)).plusMinutes(min).format(DTF);
    }
